...
const addAnswer = async (req,res) => {
   ...
   let questionsToSend = await QuestionSchema.find()
                                             .sort({createdAt:"desc"})
                                             .populate([{path:"topic",select:"name picture"},{path:"askedBy"},
...
const getQuestionAnswers = async (req,res) => {
     ...
     try {
      let questionAnswers = await AnswerSchema.find({ question: questionId })
                                              .populate([{path:"answeredBy",select:"username avatar isPro"},{path:"comments"}]);
